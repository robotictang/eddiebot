...
(cl:defmethod cl:initialize-instance :after ((m <BatteryState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BatteryState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name eddiebot_node-msg:<BatteryState> is deprecated: use eddiebot_node-msg:BatteryState instead.")))

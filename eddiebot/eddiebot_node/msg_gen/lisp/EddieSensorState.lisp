...
;//! \htmlinclude EddieSensorState.msg.html

(cl:defclass <EddieSensorState> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass EddieSensorState (<EddieSensorState>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <EddieSensorState>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'EddieSensorState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name eddiebot_node-msg:<EddieSensorState> is deprecated: use eddiebot_node-msg:EddieSensorState instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <EddieSensorState>))
...
(cl:defmethod bumps_wheeldrops-val ((m <EddieSensorState>))
...
(cl:defmethod wall-val ((m <EddieSensorState>))
...
(cl:defmethod cliff_left-val ((m <EddieSensorState>))
...
(cl:defmethod cliff_front_left-val ((m <EddieSensorState>))
...
(cl:defmethod cliff_front_right-val ((m <EddieSensorState>))
...
(cl:defmethod cliff_right-val ((m <EddieSensorState>))
...
(cl:defmethod virtual_wall-val ((m <EddieSensorState>))
...
(cl:defmethod motor_overcurrents-val ((m <EddieSensorState>))
...
(cl:defmethod dirt_detector_left-val ((m <EddieSensorState>))
...
(cl:defmethod dirt_detector_right-val ((m <EddieSensorState>))
...
(cl:defmethod remote_opcode-val ((m <EddieSensorState>))
...
(cl:defmethod buttons-val ((m <EddieSensorState>))
...
(cl:defmethod distance-val ((m <EddieSensorState>))
...
(cl:defmethod angle-val ((m <EddieSensorState>))
...
(cl:defmethod charging_state-val ((m <EddieSensorState>))
...
(cl:defmethod voltage-val ((m <EddieSensorState>))
...
(cl:defmethod current-val ((m <EddieSensorState>))
...
(cl:defmethod temperature-val ((m <EddieSensorState>))
...
(cl:defmethod charge-val ((m <EddieSensorState>))
...
(cl:defmethod capacity-val ((m <EddieSensorState>))
  ...
  (capacity m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<EddieSensorState>)))
    "Constants for message type '<EddieSensorState>"
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <EddieSensorState>) ostream)
  "Serializes a message object of type '<EddieSensorState>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EddieSensorState>) istream)
  "Deserializes a message object of type '<EddieSensorState>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EddieSensorState>)))
  "Returns string type for a message object of type '<EddieSensorState>"
  "eddiebot_node/EddieSensorState")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EddieSensorState)))
  "Returns string type for a message object of type 'EddieSensorState"
  "eddiebot_node/EddieSensorState")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EddieSensorState>)))
  "Returns md5sum for a message object of type '<EddieSensorState>"
  "9e8632c0937537603a670e96e85cd991")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EddieSensorState)))
  "Returns md5sum for a message object of type 'EddieSensorState"
  "9e8632c0937537603a670e96e85cd991")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EddieSensorState>)))
  "Returns full string definition for message of type '<EddieSensorState>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EddieSensorState)))
  "Returns full string definition for message of type 'EddieSensorState"
  (cl:format cl:nil "Header header~%~%uint8 CHARGING_NOT_CHARGING = 0~%uint8 CHARGING_CHARGING_RECOVERY = 1~%uint8 CHARGING_CHARGING = 2~%uint8 CHARGING_TRICKLE_CHARGING = 3~%uint8 CHARGING_WAITING = 4 ~%uint8 CHARGING_CHARGING_ERROR = 5~%~%uint8 bumps_wheeldrops~%bool wall~%bool cliff_left~%bool cliff_front_left~%bool cliff_front_right~%bool cliff_right~%bool virtual_wall~%uint8 motor_overcurrents~%uint8 dirt_detector_left  #roomba_only~%uint8 dirt_detector_right #roomba_only~%uint8 remote_opcode~%uint8 buttons~%int16 distance  # mm~%int16 angle # degrees~%uint8 charging_state~%uint16 voltage  # mV~%int16 current  # mA~%int8 temperature  # C~%uint16 charge  # mAh~%uint16 capacity  # mAh~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <EddieSensorState>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <EddieSensorState>))
  "Converts a ROS message object to a list"
  (cl:list 'EddieSensorState

...
(cl:defmethod cl:initialize-instance :after ((m <SetDigitalOutputs-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetDigitalOutputs-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name eddiebot_node-srv:<SetDigitalOutputs-request> is deprecated: use eddiebot_node-srv:SetDigitalOutputs-request instead.")))

(cl:ensure-generic-function 'digital_out_0-val :lambda-list '(m))
(cl:defmethod digital_out_0-val ((m <SetDigitalOutputs-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-srv:digital_out_0-val is deprecated.  Use eddiebot_node-srv:digital_out_0 instead.")
  (digital_out_0 m))

(cl:ensure-generic-function 'digital_out_1-val :lambda-list '(m))
(cl:defmethod digital_out_1-val ((m <SetDigitalOutputs-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-srv:digital_out_1-val is deprecated.  Use eddiebot_node-srv:digital_out_1 instead.")
  (digital_out_1 m))

(cl:ensure-generic-function 'digital_out_2-val :lambda-list '(m))
(cl:defmethod digital_out_2-val ((m <SetDigitalOutputs-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-srv:digital_out_2-val is deprecated.  Use eddiebot_node-srv:digital_out_2 instead.")
  (digital_out_2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetDigitalOutputs-request>)))
  ...
  "eddiebot_node/SetDigitalOutputsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetDigitalOutputs-request)))
  "Returns string type for a service object of type 'SetDigitalOutputs-request"
  "eddiebot_node/SetDigitalOutputsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetDigitalOutputs-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetDigitalOutputs-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name eddiebot_node-srv:<SetDigitalOutputs-response> is deprecated: use eddiebot_node-srv:SetDigitalOutputs-response instead.")))

(cl:ensure-generic-function 'done-val :lambda-list '(m))
(cl:defmethod done-val ((m <SetDigitalOutputs-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-srv:done-val is deprecated.  Use eddiebot_node-srv:done instead.")
  (done m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetDigitalOutputs-response>)))
  ...
  "eddiebot_node/SetDigitalOutputsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetDigitalOutputs-response)))
  "Returns string type for a service object of type 'SetDigitalOutputs-response"
  "eddiebot_node/SetDigitalOutputsResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetDigitalOutputs)))
  ...
  "eddiebot_node/SetDigitalOutputs")
/* Auto-generated by genmsg_cpp for file /home/paralax2/fuerte_workspace/sandbox/eddiebot/eddiebot_node/msg/RawEddiebotSensorState.msg */
#ifndef EDDIEBOT_NODE_MESSAGE_RAWEDDIEBOTSENSORSTATE_H
#define EDDIEBOT_NODE_MESSAGE_RAWEDDIEBOTSENSORSTATE_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct RawEddiebotSensorState_ {
  typedef RawEddiebotSensorState_<ContainerAllocator> Type;

  RawEddiebotSensorState_()
  : header()
  , bumps_wheeldrops(0)
  , wall(false)
  , cliff_left(false)
  ...
  RawEddiebotSensorState_(const ContainerAllocator& _alloc)
  : header(_alloc)
  , bumps_wheeldrops(0)
  , wall(false)
  , cliff_left(false)
  ...
  typedef boost::shared_ptr< ::eddiebot_node::RawEddiebotSensorState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::eddiebot_node::RawEddiebotSensorState_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct RawEddiebotSensorState
typedef  ::eddiebot_node::RawEddiebotSensorState_<std::allocator<void> > RawEddiebotSensorState;

typedef boost::shared_ptr< ::eddiebot_node::RawEddiebotSensorState> RawEddiebotSensorStatePtr;
typedef boost::shared_ptr< ::eddiebot_node::RawEddiebotSensorState const> RawEddiebotSensorStateConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::eddiebot_node::RawEddiebotSensorState_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::eddiebot_node::RawEddiebotSensorState_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::eddiebot_node::RawEddiebotSensorState_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::eddiebot_node::RawEddiebotSensorState_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::eddiebot_node::RawEddiebotSensorState_<ContainerAllocator> > {
  static const char* value() 
  {
    return "103d192c45e953c8bb1c3c046e89e2ff";
  }

  static const char* value(const  ::eddiebot_node::RawEddiebotSensorState_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x103d192c45e953c8ULL;
  static const uint64_t static_value2 = 0xbb1c3c046e89e2ffULL;
};

template<class ContainerAllocator>
struct DataType< ::eddiebot_node::RawEddiebotSensorState_<ContainerAllocator> > {
  static const char* value() 
  {
    return "eddiebot_node/RawEddiebotSensorState";
  }
...
template<class ContainerAllocator>
struct Definition< ::eddiebot_node::RawEddiebotSensorState_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct HasHeader< ::eddiebot_node::RawEddiebotSensorState_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::eddiebot_node::RawEddiebotSensorState_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::eddiebot_node::RawEddiebotSensorState_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::eddiebot_node::RawEddiebotSensorState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::eddiebot_node::RawEddiebotSensorState_<ContainerAllocator> & v) 
  {
    s << indent << "header: ";
s << std::endl;
...
#endif // EDDIEBOT_NODE_MESSAGE_RAWEDDIEBOTSENSORSTATE_H

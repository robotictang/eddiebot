...
;//! \htmlinclude EddiebotSensorState.msg.html

(cl:defclass <EddiebotSensorState> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass EddiebotSensorState (<EddiebotSensorState>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <EddiebotSensorState>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'EddiebotSensorState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name eddiebot_node-msg:<EddiebotSensorState> is deprecated: use eddiebot_node-msg:EddiebotSensorState instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <EddiebotSensorState>))
...
(cl:defmethod bumps_wheeldrops-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:bumps_wheeldrops-val is deprecated.  Use eddiebot_node-msg:bumps_wheeldrops instead.")
  (bumps_wheeldrops m))

(cl:ensure-generic-function 'wall-val :lambda-list '(m))
(cl:defmethod wall-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:wall-val is deprecated.  Use eddiebot_node-msg:wall instead.")
  (wall m))

(cl:ensure-generic-function 'cliff_left-val :lambda-list '(m))
(cl:defmethod cliff_left-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:cliff_left-val is deprecated.  Use eddiebot_node-msg:cliff_left instead.")
  (cliff_left m))

(cl:ensure-generic-function 'cliff_front_left-val :lambda-list '(m))
(cl:defmethod cliff_front_left-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:cliff_front_left-val is deprecated.  Use eddiebot_node-msg:cliff_front_left instead.")
  (cliff_front_left m))

(cl:ensure-generic-function 'cliff_front_right-val :lambda-list '(m))
(cl:defmethod cliff_front_right-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:cliff_front_right-val is deprecated.  Use eddiebot_node-msg:cliff_front_right instead.")
  (cliff_front_right m))

(cl:ensure-generic-function 'cliff_right-val :lambda-list '(m))
(cl:defmethod cliff_right-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:cliff_right-val is deprecated.  Use eddiebot_node-msg:cliff_right instead.")
  (cliff_right m))

(cl:ensure-generic-function 'virtual_wall-val :lambda-list '(m))
(cl:defmethod virtual_wall-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:virtual_wall-val is deprecated.  Use eddiebot_node-msg:virtual_wall instead.")
  (virtual_wall m))

(cl:ensure-generic-function 'motor_overcurrents-val :lambda-list '(m))
(cl:defmethod motor_overcurrents-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:motor_overcurrents-val is deprecated.  Use eddiebot_node-msg:motor_overcurrents instead.")
  (motor_overcurrents m))

(cl:ensure-generic-function 'dirt_detector_left-val :lambda-list '(m))
(cl:defmethod dirt_detector_left-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:dirt_detector_left-val is deprecated.  Use eddiebot_node-msg:dirt_detector_left instead.")
  (dirt_detector_left m))

(cl:ensure-generic-function 'dirt_detector_right-val :lambda-list '(m))
(cl:defmethod dirt_detector_right-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:dirt_detector_right-val is deprecated.  Use eddiebot_node-msg:dirt_detector_right instead.")
  (dirt_detector_right m))

(cl:ensure-generic-function 'remote_opcode-val :lambda-list '(m))
(cl:defmethod remote_opcode-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:remote_opcode-val is deprecated.  Use eddiebot_node-msg:remote_opcode instead.")
  (remote_opcode m))

(cl:ensure-generic-function 'buttons-val :lambda-list '(m))
(cl:defmethod buttons-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:buttons-val is deprecated.  Use eddiebot_node-msg:buttons instead.")
  (buttons m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:distance-val is deprecated.  Use eddiebot_node-msg:distance instead.")
  (distance m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:angle-val is deprecated.  Use eddiebot_node-msg:angle instead.")
  (angle m))

(cl:ensure-generic-function 'charging_state-val :lambda-list '(m))
(cl:defmethod charging_state-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:charging_state-val is deprecated.  Use eddiebot_node-msg:charging_state instead.")
  (charging_state m))

(cl:ensure-generic-function 'voltage-val :lambda-list '(m))
(cl:defmethod voltage-val ((m <EddiebotSensorState>))
...
(cl:defmethod current-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:current-val is deprecated.  Use eddiebot_node-msg:current instead.")
  (current m))

(cl:ensure-generic-function 'temperature-val :lambda-list '(m))
(cl:defmethod temperature-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:temperature-val is deprecated.  Use eddiebot_node-msg:temperature instead.")
  (temperature m))

(cl:ensure-generic-function 'charge-val :lambda-list '(m))
(cl:defmethod charge-val ((m <EddiebotSensorState>))
...
(cl:defmethod capacity-val ((m <EddiebotSensorState>))
...
(cl:defmethod wall_signal-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:wall_signal-val is deprecated.  Use eddiebot_node-msg:wall_signal instead.")
  (wall_signal m))

(cl:ensure-generic-function 'cliff_left_signal-val :lambda-list '(m))
(cl:defmethod cliff_left_signal-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:cliff_left_signal-val is deprecated.  Use eddiebot_node-msg:cliff_left_signal instead.")
  (cliff_left_signal m))

(cl:ensure-generic-function 'cliff_front_left_signal-val :lambda-list '(m))
(cl:defmethod cliff_front_left_signal-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:cliff_front_left_signal-val is deprecated.  Use eddiebot_node-msg:cliff_front_left_signal instead.")
  (cliff_front_left_signal m))

(cl:ensure-generic-function 'cliff_front_right_signal-val :lambda-list '(m))
(cl:defmethod cliff_front_right_signal-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:cliff_front_right_signal-val is deprecated.  Use eddiebot_node-msg:cliff_front_right_signal instead.")
  (cliff_front_right_signal m))

(cl:ensure-generic-function 'cliff_right_signal-val :lambda-list '(m))
(cl:defmethod cliff_right_signal-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:cliff_right_signal-val is deprecated.  Use eddiebot_node-msg:cliff_right_signal instead.")
  (cliff_right_signal m))

(cl:ensure-generic-function 'user_digital_outputs-val :lambda-list '(m))
(cl:defmethod user_digital_outputs-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:user_digital_outputs-val is deprecated.  Use eddiebot_node-msg:user_digital_outputs instead.")
  (user_digital_outputs m))

(cl:ensure-generic-function 'user_digital_inputs-val :lambda-list '(m))
(cl:defmethod user_digital_inputs-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:user_digital_inputs-val is deprecated.  Use eddiebot_node-msg:user_digital_inputs instead.")
  (user_digital_inputs m))

(cl:ensure-generic-function 'user_analog_input-val :lambda-list '(m))
(cl:defmethod user_analog_input-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:user_analog_input-val is deprecated.  Use eddiebot_node-msg:user_analog_input instead.")
  (user_analog_input m))

(cl:ensure-generic-function 'charging_sources_available-val :lambda-list '(m))
(cl:defmethod charging_sources_available-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:charging_sources_available-val is deprecated.  Use eddiebot_node-msg:charging_sources_available instead.")
  (charging_sources_available m))

(cl:ensure-generic-function 'oi_mode-val :lambda-list '(m))
(cl:defmethod oi_mode-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:oi_mode-val is deprecated.  Use eddiebot_node-msg:oi_mode instead.")
  (oi_mode m))

(cl:ensure-generic-function 'song_number-val :lambda-list '(m))
(cl:defmethod song_number-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:song_number-val is deprecated.  Use eddiebot_node-msg:song_number instead.")
  (song_number m))

(cl:ensure-generic-function 'song_playing-val :lambda-list '(m))
(cl:defmethod song_playing-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:song_playing-val is deprecated.  Use eddiebot_node-msg:song_playing instead.")
  (song_playing m))

(cl:ensure-generic-function 'number_of_stream_packets-val :lambda-list '(m))
(cl:defmethod number_of_stream_packets-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:number_of_stream_packets-val is deprecated.  Use eddiebot_node-msg:number_of_stream_packets instead.")
  (number_of_stream_packets m))

(cl:ensure-generic-function 'requested_velocity-val :lambda-list '(m))
(cl:defmethod requested_velocity-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:requested_velocity-val is deprecated.  Use eddiebot_node-msg:requested_velocity instead.")
  (requested_velocity m))

(cl:ensure-generic-function 'requested_radius-val :lambda-list '(m))
(cl:defmethod requested_radius-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:requested_radius-val is deprecated.  Use eddiebot_node-msg:requested_radius instead.")
  (requested_radius m))

(cl:ensure-generic-function 'requested_right_velocity-val :lambda-list '(m))
(cl:defmethod requested_right_velocity-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:requested_right_velocity-val is deprecated.  Use eddiebot_node-msg:requested_right_velocity instead.")
  (requested_right_velocity m))

(cl:ensure-generic-function 'requested_left_velocity-val :lambda-list '(m))
(cl:defmethod requested_left_velocity-val ((m <EddiebotSensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:requested_left_velocity-val is deprecated.  Use eddiebot_node-msg:requested_left_velocity instead.")
  (requested_left_velocity m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<EddiebotSensorState>)))
    "Constants for message type '<EddiebotSensorState>"
  '((:OI_MODE_OFF . 0)
    (:OI_MODE_PASSIVE . 1)
    (:OI_MODE_SAFE . 2)
    (:OI_MODE_FULL . 3)
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <EddiebotSensorState>) ostream)
  "Serializes a message object of type '<EddiebotSensorState>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EddiebotSensorState>) istream)
  "Deserializes a message object of type '<EddiebotSensorState>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EddiebotSensorState>)))
  "Returns string type for a message object of type '<EddiebotSensorState>"
  "eddiebot_node/EddiebotSensorState")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EddiebotSensorState)))
  "Returns string type for a message object of type 'EddiebotSensorState"
  "eddiebot_node/EddiebotSensorState")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EddiebotSensorState>)))
  "Returns md5sum for a message object of type '<EddiebotSensorState>"
  "d8f8ec7fa031fc9cc88e8319cd08a785")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EddiebotSensorState)))
  "Returns md5sum for a message object of type 'EddiebotSensorState"
  "d8f8ec7fa031fc9cc88e8319cd08a785")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EddiebotSensorState>)))
  "Returns full string definition for message of type '<EddiebotSensorState>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EddiebotSensorState)))
  "Returns full string definition for message of type 'EddiebotSensorState"
  (cl:format cl:nil "uint8 OI_MODE_OFF = 0~%uint8 OI_MODE_PASSIVE = 1~%uint8 OI_MODE_SAFE = 2~%uint8 OI_MODE_FULL = 3~%~%uint8 REMOTE_LEFT = 129~%uint8 REMOTE_FORWARD = 130 ~%uint8 REMOTE_RIGHT = 131 ~%uint8 REMOTE_SPOT = 132 ~%uint8 REMOTE_MAX = 133 ~%uint8 REMOTE_SMALL = 134 ~%uint8 REMOTE_MEDIUM = 135 ~%uint8 REMOTE_LARGE = 136 ~%uint8 REMOTE_CLEAN = 136 ~%uint8 REMOTE_PAUSE = 137 ~%uint8 REMOTE_POWER = 138 ~%uint8 REMOTE_ARC_LEFT = 139 ~%uint8 REMOTE_ARC_RIGHT = 140 ~%uint8 REMOTE_DRIVE_STOP = 141 ~%# Scheduling remote~%uint8 REMOTE_SEND_ALL = 142 ~%uint8 REMOTE_SEEK_DOCK = 143 ~%# Home base~%uint8 REMOTE_RESERVED = 240 ~%uint8 REMOTE_FORCE_FIELD = 242 ~%uint8 REMOTE_GREEN_BUOY = 244 ~%uint8 REMOTE_GREEN_BUOY_AND_FORCE_FIELD = 246 ~%uint8 REMOTE_RED_BUOY = 248 ~%uint8 REMOTE_RED_BUOY_AND_FORCE_FIELD = 250 ~%uint8 REMOTE_RED_BUOY_AND_GREEN_BUOY = 252 ~%uint8 REMOTE_RED_BUOY_AND_GREEN_BUOY_AND_FORCE_FIELD = 254 ~%uint8 REMOTE_NONE = 255~%~%uint8 CHARGING_NOT_CHARGING = 0~%uint8 CHARGING_CHARGING_RECOVERY = 1~%uint8 CHARGING_CHARGING = 2~%uint8 CHARGING_TRICKLE_CHARGING = 3~%uint8 CHARGING_WAITING = 4 ~%uint8 CHARGING_CHARGING_ERROR = 5~%~%Header header~%~%uint8 bumps_wheeldrops~%bool wall~%bool cliff_left~%bool cliff_front_left~%bool cliff_front_right~%bool cliff_right~%bool virtual_wall~%uint8 motor_overcurrents~%uint8 dirt_detector_left  #roomba_only~%uint8 dirt_detector_right #roomba_only~%uint8 remote_opcode~%uint8 buttons~%float64 distance  # m~%float64 angle #radians~%uint8 charging_state~%uint16 voltage  # mV~%int16 current  # mA~%int8 temperature  # C~%uint16 charge  # mAh~%uint16 capacity  # mAh~%~%uint16 wall_signal~%uint16 cliff_left_signal~%uint16 cliff_front_left_signal~%uint16 cliff_front_right_signal~%uint16 cliff_right_signal~%uint8 user_digital_outputs~%uint8 user_digital_inputs~%uint16 user_analog_input~%uint8 charging_sources_available~%uint8 oi_mode~%uint8 song_number~%bool song_playing~%~%uint8 number_of_stream_packets~%int32 requested_velocity  # m/s~%int32 requested_radius  # m~%int32 requested_right_velocity  # m/s~%int32 requested_left_velocity  # m/s~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <EddiebotSensorState>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <EddiebotSensorState>))
  "Converts a ROS message object to a list"
  (cl:list 'EddiebotSensorState

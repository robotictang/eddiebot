...
(cl:defmethod cl:initialize-instance :after ((m <Turtle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Turtle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot_node-msg:<Turtle> is deprecated: use turtlebot_node-msg:Turtle instead.")))

(cl:ensure-generic-function 'linear-val :lambda-list '(m))
(cl:defmethod linear-val ((m <Turtle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_node-msg:linear-val is deprecated.  Use turtlebot_node-msg:linear instead.")
  (linear m))

(cl:ensure-generic-function 'angular-val :lambda-list '(m))
(cl:defmethod angular-val ((m <Turtle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_node-msg:angular-val is deprecated.  Use turtlebot_node-msg:angular instead.")
  (angular m))

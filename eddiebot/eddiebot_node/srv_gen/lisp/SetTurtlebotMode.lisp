...
(cl:defmethod cl:initialize-instance :after ((m <SetTurtlebotMode-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetTurtlebotMode-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot_node-srv:<SetTurtlebotMode-request> is deprecated: use turtlebot_node-srv:SetTurtlebotMode-request instead.")))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <SetTurtlebotMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_node-srv:mode-val is deprecated.  Use turtlebot_node-srv:mode instead.")
  (mode m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetTurtlebotMode-request>)))
  ...
  "turtlebot_node/SetTurtlebotModeRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetTurtlebotMode-request)))
  "Returns string type for a service object of type 'SetTurtlebotMode-request"
  "turtlebot_node/SetTurtlebotModeRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetTurtlebotMode-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetTurtlebotMode-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot_node-srv:<SetTurtlebotMode-response> is deprecated: use turtlebot_node-srv:SetTurtlebotMode-response instead.")))

(cl:ensure-generic-function 'valid_mode-val :lambda-list '(m))
(cl:defmethod valid_mode-val ((m <SetTurtlebotMode-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_node-srv:valid_mode-val is deprecated.  Use turtlebot_node-srv:valid_mode instead.")
  (valid_mode m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetTurtlebotMode-response>)))
  ...
  "turtlebot_node/SetTurtlebotModeResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetTurtlebotMode-response)))
  "Returns string type for a service object of type 'SetTurtlebotMode-response"
  "turtlebot_node/SetTurtlebotModeResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetTurtlebotMode)))
  ...
  "turtlebot_node/SetTurtlebotMode")
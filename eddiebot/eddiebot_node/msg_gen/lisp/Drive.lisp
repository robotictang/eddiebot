...
(cl:defmethod cl:initialize-instance :after ((m <Drive>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Drive)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name eddiebot_node-msg:<Drive> is deprecated: use eddiebot_node-msg:Drive instead.")))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <Drive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:velocity-val is deprecated.  Use eddiebot_node-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'radius-val :lambda-list '(m))
(cl:defmethod radius-val ((m <Drive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader eddiebot_node-msg:radius-val is deprecated.  Use eddiebot_node-msg:radius instead.")
  (radius m))
